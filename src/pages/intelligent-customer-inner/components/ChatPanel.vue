...
const typeTimers = ref<any>({})
const draining = ref(false)
const currentConversationId = ref<string | null>(null)
const renderedMsgIds = ref<any>({})
const renderedPartCounts = ref<any>({})
...
const caseInfo = ref<HTMLElement | null>(null)
const commTextarea = ref<HTMLTextAreaElement | null>(null)
